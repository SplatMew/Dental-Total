...
import { serviceData } from "./dataExports";
      ...
      <nav className=" text-white sticky top-0 z-50 shadow-md khula-regular lg:text-2xl sm:text-auto ">
        <div className="dental-navbar px-6 py-4 mx-auto flex justify-around items-center">
          ...
          <ul className="flex space-x-6 ">
            <li className="hover:text-blue-200 transition-colors duration-200 py-2 pr-6 flex items-center border-r-1">
              <Link to="/">Home</Link>
            </li>
            <li className="hover:text-blue-200 transition-colors duration-200 py-2 pr-6 flex items-center border-r-1">
            ...
            >
              <Link
                to="/servicios"
                className="hover:text-blue-200 transition-colors duration-200 py-2 pr-6 flex items-center border-r-1"
              >
                Servicios
              </Link>
              <ul
                className={`absolute top-full left-0 navbar-fade text-black shadow-lg mt-2 rounded-lg min-w-[200px] z-50
